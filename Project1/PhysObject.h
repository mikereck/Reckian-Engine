...
public:
	...
	PhysObject(Mesh* mesh, glm::vec3 position = glm::vec3(0, 0, 0), float scale = 1, glm::vec3 color = glm::vec3(1, 0, 0), float mass = 1, glm::vec3 velocity = glm::vec3(0, 0, 0), glm::vec3 accel = glm::vec3(0, 0, 0));
